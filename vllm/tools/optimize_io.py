...
def main(args):
    ...
    with st.safe_open(os.path.join(args.input, "deltazip-compressed.safetensors"), "torch") as f:
        for key in f.keys():
...
if __name__=="__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Optimize the I/O of a safetensors file")
    parser.add_argument("--input", type=str, help="Input file path")
    parser.add_argument("--tp-size", type=int, help="Tensor Parallelism Size", default=1)
