...
class ModelConfig:
    ...
    def __init__(
        ...
        self.max_model_len = _get_and_verify_max_len(self.hf_text_config, max_model_len)
    ...
    def _verify_quantization(self) -> None:
        ...
        if hf_quant_config is not None:
            ...
            if (
                ...
                logger.info(
                    "The model is serialized in Marlin format. " "Using Marlin kernel."
                )
    ...
    def __str__(self):
        return (
            f"ModelConfig(model={self.model}, "
...
class CacheConfig:
    ...
    def __str__(self) -> str:
        return (
            f"CacheConfig(block_size={self.block_size}, "
...
class TokenizerPoolConfig:
    ...
    def __str__(self) -> str:
        return (
            f"TokenizerPoolConfig(pool_size={self.pool_size}, "
...
class ParallelConfig:
    ...
    def __str__(self) -> str:
        return (
            f"ParallelConfig(pipeline_parallel_size={self.pipeline_parallel_size}, "
...
class DeviceConfig:
    ...
    def __str__(self) -> str:
        return f"DeviceConfig(device_type={self.device_type}, " f"device={self.device})"
