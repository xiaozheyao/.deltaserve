...
class RayTokenizerGroupPool(BaseTokenizerGroup):
    ...
    @classmethod
    def from_config(
        cls, tokenizer_pool_config: TokenizerPoolConfig, **init_kwargs
    ...
    def __init__(
        ...
        **tokenizer_config
        ...
        ray_tokenizer_group_cls = ray.remote(self._worker_cls).options(
            **ray_actor_options
        )
        self.tokenizer_actors = [
            ray_tokenizer_group_cls.remote(
                tokenizer_id,
                enable_lora,
                max_num_seqs,
                max_input_length,
    ...
    def ping(self):
        return ray.get([actor.ping.remote() for actor in self.tokenizer_actors])
