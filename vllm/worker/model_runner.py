...
class ModelRunner:
    ...
    def _prepare_prompt(
        ...
        for seq_group_metadata in seq_group_metadata_list:
            ...
            delta_index_mapping.append([delta_id] * (prompt_len - computed_len))
        ...
        delta_index_mapping = [
            _pad_to_max(mapping, max_prompt_len, pad=0)
            for mapping in delta_index_mapping
        ]
    ...
    def _prepare_decode(
        ...
        delta_index_mapping = [
            _pad_to_max(mapping, 1, pad=0) for mapping in delta_index_mapping
        ]
    ...
    def prepare_input_tensors(
        ...
        if self.is_driver_worker:
            ...
            delta_mapping = metadata_dict["delta_mapping"]
            delta_requests = metadata_dict["delta_requests"]
