...
def plot(args):
    ...
    for i, system in enumerate(systems):
        ...
        fig2 = px.bar(system_df, x="id", y="time", color="type", color_discrete_sequence=color_palette['general'])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, help="Input file", default=".artifact/benchmarks/results")
    parser.add_argument("--output", type=str, help="Output folder", default=".artifact/benchmarks/results")
    parser.add_argument("--type", type=str, choices=['nfs', 'nvme'], help="harddrive", default='nfs')
