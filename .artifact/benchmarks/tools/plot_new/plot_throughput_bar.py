...
def plot(args):
    ...
    for metric in metrics:
        ...
        baseline_df = baseline_df.set_index(["distribution","ar"])["throughput"].unstack()
        delta_8_df = delta_8_df.set_index(["distribution","ar"])["throughput"].unstack()
        delta_12_df = delta_12_df.set_index(["distribution","ar"])["throughput"].unstack()
